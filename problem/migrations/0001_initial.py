    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professor', models.ForeignKey(db_column='professor', on_delete=django.db.models.deletion.CASCADE, related_name='problem_professor', to=settings.AUTH_USER_MODEL, to_field='username')),
            ],
            options={
                'db_table': 'problem',
            },
